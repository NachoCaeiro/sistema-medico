...
def build_pdf_from_record(record):
    ...
    hline(y); y += 2
    y = label_value("EMPRESA:", record.get("company_name", "") or "", y=y, label_w=28)
    y += 1
    ...
    y = label_value("DNI:", record.get("document_number", "") or "", y=y, label_w=12)
    y += 1
